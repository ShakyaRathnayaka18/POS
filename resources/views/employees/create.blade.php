...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Create New Employee</h2>

            <form action="{{ route('employees.store') }}" method="POST" x-data="employeeForm()">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                <option value="hourly" {{ old('employment_type') == 'hourly' ? 'selected' : '' }}>Hourly</option>
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        id="notes"
                        rows="4"
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
