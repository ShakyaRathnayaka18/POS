            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    @if($stock->batch->expiry_date)
                        <span class="{{ $stock->batch->expiry_date < now() ? 'text-red-600 font-semibold' : 'text-gray-900' }}">
            ...
            <div class="space-y-4">
                <div class="bg-gray-50 p-4 rounded-lg">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-gray-900 text-2xl font-bold">{{ $stock->quantity }}</span>
                    </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-2xl font-bold {{ $stock->available_quantity > 0 ? 'text-green-600' : 'text-red-600' }}">
                            {{ $stock->available_quantity }}
                        </span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="{{ $stock->available_quantity > 0 ? 'bg-green-600' : 'bg-red-600' }} h-2 rounded-full"
                             style="width: {{ $stock->quantity > 0 ? ($stock->available_quantity / $stock->quantity * 100) : 0 }}%"></div>
                    </div>
