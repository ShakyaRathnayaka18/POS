        ...
        <form class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" value="PO-2024-003" readonly class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-600 dark:text-white">
                </div>
                <div>
                ...
                <div class="flex justify-end">
                    <div class="w-64 space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium dark:text-white">$0.00</span>
                        </div>
                        <div class="flex justify-between">
            ...
            <div class="border-t border-gray-200 dark:border-gray-600 pt-6">
                ...
                <textarea rows="3" placeholder="Additional notes or instructions..." class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"></textarea>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-600">
                ...
                <button type="submit" class="bg-primary-600 text-white px-6 py-2 rounded-md hover:bg-primary-700">Send PO</button>
            </div>
        </form>
    </div>
</div>
