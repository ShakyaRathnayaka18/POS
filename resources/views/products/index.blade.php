    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <form method="GET" action="{{ route('products.index') }}">
            ...
            <div class="flex justify-end mt-4">
                <button type="submit" class="bg-blue-500 text-black py-3 px-4 rounded-md hover:bg-blue-600 font-medium transition-colors" style="border: 1px solid #60a5fa !important;">
                    Filter
                </button>
            </div>
        </form>
